...
def createJiraIssue(exception_query_string, stackExItems):
	...
	filecontents = filecontents.replace("__description__","The Jenkins build failed with the exception marked in the title.<br>View the complete error log at:"+jenkins_build_url+"<br>We have the following possible solutions on Stack Exchange which match the Exception.\n"+str(stackExItems[0])+"\n"+str(stackExItems[1])+"\n"+str(stackExItems[2])+"\n"+str(stackExItems[3])+"\n")	
